                              ...
                              )
{
  ...
  edm::LogError  ("cat_B")   << "LogError was used to send this message";
  ...
  edm::LogInfo   ("cat_B")   << "LogInfo was used to send this message about"
  			     << file_ << "which is a string";
  edm::LogInfo   ("cat_B")   << "LogInfo was used to send this message about"
  			     << empty_ << "which is an empty string";
       LogDebug  ("cat_A")   << "LogDebug was used to send this message";
       LogDebug  ("cat_B")   << "LogDebug was used to send this message";
...
using edmreftest::UnitTestClient_A;
